      ...
      <div class="text-white py-12 flex flex-col min-h-[70vh] items-start justify-center md:items-start">
        <div class="text-center w-full space-y-6">
          ...
          <p class="text-base sm:text-lg">
            Компания «Kusa-Beton» занимается производством и доставкой бетона и строительных растворов по всей территории Казахстана, гарантируя высокое качество продукции и соблюдение сроков
          </p>
          <div class="mt-6">
            <RequestModal />
          </div>
